# R4 engineering review — 2026-09-24 (historical snapshot)

Historical R4 report; relative links below refer to the repository root.
Current state is in ../REPORT.md. Later V1 feedback supersedes the old
joystick assembly instructions.
