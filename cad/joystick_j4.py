...
def cap():
    ...
    # The bigger sphere reaches down into the stick socket; cut J2's exact
    # socket back out (the 2026-09-26 J4 print had it 1.5 mm too shallow).
    c-=blank-old
...
def checks():
    ...
    sock=J.cylinder(J.NECK,J.BOTTOM-J.P.TOOL_EXT,J.BOTTOM+J2.ROUND_DEPTH+J2.SQUARE_DEPTH+.5)
    ...
    return c,dict(
        ...
        joystick_socket_void_identical_to_J2=vol(sock-c)>30 and abs(vol(sock-c)-vol(sock-old))<1e-4,
