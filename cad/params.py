...
LID_TOP = 0.70     # D7-LID: flat top exactly1mm above glass
...
CAP_FLANGE_T = 0.4 # D7-BUTTON, side wings below plunger
CAP_FLANGE_Z = 1.8 # D7-BUTTON
CAP_BODY_CLEAR = 0.25 # D7-BUTTON, switch-body relief per side
...
JOY_FLANGE_Z = 0.7   # D8-JOY, rear heel behind PCB edge
JOY_FLANGE_T = 0.3   # D8-JOY
...
JOY_POCKET_TOP = 2.45 # D8-POCKET
JOY_OPEN_X, JOY_OPEN_Y = 12.8, 13.5 # D8-POCKET
JOY_OPEN_DY = 0.65 # D8-POCKET, y-6.1..+7.4
JOY_ARM_HALF_Y = 1.2 # D7-JOY
JOY_TAB_IN, JOY_TAB_OUT = 6.3, 8.3 # D7-JOY
JOY_TAB_POCKET_X, JOY_TAB_POCKET_Y = 8.8, 2.0 # D7-POCKET half sizes
JOY_ARM_PROFILE = ((1.8,8.7),(2.7,8.7),(6.3,5.1),(6.3,2.5),(7.3,1.0),(7.8,1.0),(7.8,.7),(7.0,.7),(7.0,1.15),(6.6,1.7),(6.0,2.1),(5.8,2.1),(5.8,4.8),(1.8,8.5)) # D8-JOY, rear y/z
JOY_REAR_POCKET_X = 2.5 # D8-POCKET half width
JOY_REAR_POCKET_Y0, JOY_REAR_POCKET_Y1 = 5.5, 8.3 # D8-POCKET
JOY_REAR_POCKET_Z0 = -1.5 # D8-POCKET
