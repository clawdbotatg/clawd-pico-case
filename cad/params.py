...
JOY_CAP_TOP = 3.0  # joystick cap top above the lid top
JOY_CAP_FLANGE_T = 1.5  # joystick cap top disc thickness
JOY_CAP_FLANGE_OVER = 0.5  # top disc past the hole edge, radius
JOY_CAP_SIDE_CLEAR = 0.6   # cap skirt to hole edge, radius (J7/J8 tilt unmeasured)
JOY_CAP_LIFT = 1.0 # cap bottom above the joystick body top (J3, a guess)
JOY_SOCKET_CLEAR = 0.15    # square socket over the 1.86 stem, total
JOY_SOCKET_TIP_CLEAR = 0.3 # socket roof above the stem tip (J6); the socket is open at the cap bottom
